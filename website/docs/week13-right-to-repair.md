---
sidebar_position: 13
sidebar_label: "Week 13: Fix-It Detective"
title: "Week 13: Fix-It Detective (Designing for Disassembly and Reuse)"
description: "Children look for clues that show whether an object was designed to be fixed, opened, and reused."
---
...
1. Look at both objects slowly.
2. List the visible clues.
3. Sort the clues into helpful for repair or harder for repair.
4. Decide which object seems more repair-friendly.
...
1. Name what makes the current object hard to repair.
2. Redesign it with friendlier clues.
3. Add labels for parts, fasteners, and instructions.
4. Explain how the new design keeps the object in use longer.
