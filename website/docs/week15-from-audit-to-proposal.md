---
sidebar_position: 15
sidebar_label: "Week 15: Turn Your Idea Into a Plan"
title: "Week 15: Turn Your Idea Into a Plan Someone Could Try"
description: "Children turn a redesign idea into a clear plan using counts, observations, helpers, and honest next steps."
---
...
1. Rewrite the current path in plain language.
2. Add one real number or estimate.
3. Name where the pile grows now.
4. Keep the wording short and concrete.
...
2. Add one drawing that shows the better loop.
3. Check whether the plan still feels realistic.
4. Revise any part that sounds too vague.
