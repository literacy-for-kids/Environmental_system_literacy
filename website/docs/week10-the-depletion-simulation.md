---
sidebar_position: 10
sidebar_label: "Week 10: The Shared Fish Pond Game"
title: "Week 10: The Shared Fish Pond Game (The Resource Pool Game)"
description: "Children play a simple resource game to learn how rules shape what happens in a shared system."
---

# Week 10: The Shared Fish Pond Game (The Resource Pool Game)
...
| Core vocabulary | shared, round, grow back, rule, pool |
| Older learner words | common-pool resource, regeneration rate, maximum sustainable yield, tragedy of the commons |
...
| round | One turn in a repeating game |
| grow back | To return over time |
| rule | A condition that shapes what players can do |
| pool | The amount everyone is using from |
...
| Round | Fish left | Fish grew back? |
|---|---|---|
| 1 |  |  |
| 2 |  |  |
| 3 |  |  |
