---
sidebar_position: 12
sidebar_label: "Week 12: Can This Go Back Into a Loop?"
title: "Week 12: Can This Go Back Into a Loop? (How to Close an Open Loop)"
description: "Children sort objects by how easily they can return to soil, a factory loop, or a hard-to-loop pile."
---

# Week 12: Can This Go Back Into a Loop? (How to Close an Open Loop)
...
|---|---|
| sort | To group things by a rule |
| soil loop | A return path that can safely go back to nature |
| factory loop | A return path that needs tools or machines to become useful again |
| hard-to-loop | Difficult to return because it is mixed, dirty, glued, or unsafe |
| redesign | To change something so it works better |
