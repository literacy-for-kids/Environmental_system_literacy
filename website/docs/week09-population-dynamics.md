---
sidebar_position: 9
sidebar_label: "Week 9: Why Numbers Go Up and Down"
title: "Week 9: Why Numbers Go Up and Down (What Happens When Demand Exceeds Supply)"
description: "Children explore population patterns with simple curve shapes, tokens, and feedback ideas."
---
...
1. Add more and more counters quickly to show a rocket pattern.
2. Slow the increase and flatten it for a leveling-off pattern.
3. Push the pattern too far and then remove many counters for a crash.
4. Match each shape to a simple story.
...
1. Start with rabbit numbers rising.
2. Let wolf numbers rise a little later.
3. Show rabbits dropping after wolves increase.
4. Show wolves dropping later when rabbits are scarce.
5. Repeat the wave pattern once more.
